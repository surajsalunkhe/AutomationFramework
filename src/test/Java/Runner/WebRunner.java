...
public class WebRunner extends AbstractTestNGCucumberTests {
    ...
    private String extentConfigPath=System.getProperty("user.dir")+"/src/test/resources/config/Web/ReportConfig/extent-config.xml";
    ...
    public void tearDownClass() throws Exception {
        ...
        Reporter.loadXMLConfig(extentConfigPath);
